...
const Pagination = ({
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6 border-t border-gray-100 dark:border-[#2f2f2f] mt-6 animate-fadeIn">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                ...
                {onPageSizeChange && (
                    <div className="flex items-center gap-2 bg-gray-50 dark:bg-[#252525] rounded-lg px-2 py-1 border border-gray-200 dark:border-[#2f2f2f]">
                        ...
                        >
                            {pageSizeOptions.map(size => (
                                <option key={size} value={size} className="bg-white dark:bg-[#252525]">
                                    {size}
                                </option>
                            ))}
                        </select>
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="p-2 rounded-lg bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#2f2f2f] text-gray-600 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm disabled:shadow-none"
                    title="Previous Page"
                >
                    <FaChevronLeft />
                </button>

                <span className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#2f2f2f] rounded-lg shadow-sm">
